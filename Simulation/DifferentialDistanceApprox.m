...
for kk = 1:N
    ...
    for k=1:25
        ...
        estDistances  = CalculateDotProduct(estXCVRTarget, XCVRBase);
        ...
        for i=1:7
            ...
            G(1:24,i)  = (CalculateDotProduct(pointsTemp, XCVRBase) - ...
...
suptitle('Approx Differential Distance Measurements (1000 Samples)')
